...
This project focuses on **mastering responsive web design techniques** to create **flexible, user-friendly interfaces across different devices and screen sizes**. It covers the fundamentals of **mobile-first design, media queries, and CSS units for flexible layouts**, ensuring that web applications adapt seamlessly to various viewports. You’ll learn how to implement **responsive vs. adaptive design**, choose appropriate **breakpoints and sizes**, and apply best practices for making websites fully responsive. The project aims to enhance your ability to build **modern, accessible, and scalable web experiences**.  
...
<details>
<summary><b>Responsive web design</summary></b><br>
...
This CSS rule applies border-box to all elements, including their pseudo-elements, ensuring that padding and borders are included in the specified width and height
...
In your [01-styles.css](01-styles.css) file
...
* File: [01-styles.css](01-styles.css), [01-index.html](01-index.html)

#### 1. Make the container flexible

Using the previous file as the base, in your [02-styles.css](02-styles.css) file update the `.container` selector by changing `width` to `max-width`

If you resize your browser, you should see that the content is resizing.

**Wide screen:**

![Image](images/wide_screen.jpg)

**Narrow screen:**

![Image](images/narrow_screen.jpg)

**Repo:**

* GitHub Repository: `alx-frontend`
* Directory: `0x03-responsive_design`
* File: [02-styles.css](02-styles.css), [02-index.html](02-index.html)
...
**In your [02-1-styles.css](02-1-styles.css) File:**
...
![Image](images/rendering_on_wide_screen_1.jpg)

**Rendering on screen with max-width: 767px**

![Image](images/rendering_on_wide_screen_2.jpg)

**Rendering on screen with max-width: 767px, you can see the navbar is hidden**

![Image](images/rendering_on_wide_screen_3.jpg)

**Repo:**

* GitHub Repository: `alx-frontend`
* Directory: `0x03-responsive_design`
* File: [02-1-styles.css](02-1-styles.css), [02-1-index.html](02-1-index.html)
...
* GitHub Repository: `alx-frontend`
* Directory: `0x03-responsive_design`
* File: [03-index.html](03-index.html), [03-styles.css](03-index.html)
...
![Image](images/rendering_on_wide_screen_4.jpg)
...
![Image](images/rendering_on_wide_screen_5.jpg)
...
in [08-styles.css](08-styles.css), at the end of the` /* Card WORK`
...
![Image](images/rendering_on_wide_screen_9.jpg)
...
in [09-styles.css](09-styles.css), in the `/* Footer` section
...
![Image](images/rendering_on_wide_screen_10.jpg)
...
In [10-index.html](10-index.html), in the `body` tag, add the class `article-page`

In [10-styles.css](10-styles.css), in the `/* Section HERO` section, just before the media query:
...
![Image](images/rendering_on_wide_screen_11.jpg)
...
in [100-styles.css](100-styles.css) (from [10-styles.css](10-styles.css))
...
![Image](images/rendering_on_wide_screen_12.jpg)

**Rendering on screen of max-width: 767px**

![Image](images/rendering_on_wide_screen_13.jpg)
